class Node < ApplicationRecord
  ...
  has_many :descendants, class_name: 'Node', through: :ancestor_paths, source: :descendant
  has_many :ancestors, class_name: 'Node', through: :descendant_paths, source: :ancestor
